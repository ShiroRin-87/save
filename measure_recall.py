...
print(f"{'QID':<8} {'Ref':<20} | {'A':^5} {'B':^5} {'C':^5} {'D':^5}")
print(f"{'':8} {'':20} | {'':5} {'':5} {'':5} {'':5}")
print("-" * 50)
...
for qid, method_results in sorted(recall.items()):
    ...
    print(f"{qid:<8} {ref[:18]:<20} | {statuses['A']:^5} {statuses['B']:^5} {statuses['C']:^5} {statuses['D']:^5}")
...
print(f"{'':12} {'':12} {'':}")
for m in METHODS:
    names = {"A": "A: Direct", "B": "B: +gap", "C": "C: Hypo+gap", "D": "D: SEVE+gap"}
